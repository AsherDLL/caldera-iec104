...
class IEC104Service:
    def __init__(self, services, name, description):
        ...
        self.log = logging.getLogger('iec104_svc')

    @template('iec104.html')
    ...
    async def _get_plugin_data(self):
        # Collapse ability executor variants down to one entry per ability id.
        abilities = {
            a.ability_id: {
                'name': a.name,
                'tactic': a.tactic,
            ...
            if await a.which_plugin() == 'iec104'
        }
